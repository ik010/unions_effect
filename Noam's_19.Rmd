...
# nulls_table_to_show<- 
# results_table <- knitr::kable(nulls_table, format = "latex", booktabs = TRUE, align = "c") %>%
#   kable_styling(bootstrap_options = c("striped", "hover"), full_width = FALSE) %>%
#   column_spec(1, bold = T) %>%
#   add_header_above(c(" " = 1, "Employed rate" = 4, "Education non-null rate" = 4, "Age non-null rate" = 4, "Religion non-null rate" = 4)) %>%
