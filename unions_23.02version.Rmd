...
check_null_percent <- function(dt, col) {
  ...
  print(paste0(" non na rows are ", non_nas_rows))
  non_nas_percent <- non_nas_rows / nrow(dt) * 100
  print(paste0("non_nas_percent are ", non_nas_percent))
  non_nas_percent_display <- beutify_percent(non_nas_percent)
  print(paste0("non_nas_percent_display are ", non_nas_percent_display))
